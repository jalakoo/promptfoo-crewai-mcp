...
def call_crew(
    prompt: str,
    full_model_name: str = "openai/o3-mini",
) -> Dict[str, str]:
    ...
    try:
        ...
        params = {"prompt": prompt, "full_model_name": full_model_name}
        ...
        return {"output": f"Error: Failed to get response from the server. {str(e)}"}
